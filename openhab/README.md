...
In order for it to work with your smarthome, it's currently required that you follow the item structure (name+label+group) conventions from the [OpenHab demo](https://github.com/openhab/openhab-distro/blob/master/features/distro-resources/src/main/resources/items/demo.items) defined in [the OpenHab docs](https://github.com/openhab/openhab1-addons/wiki/Controlling-openHAB-with-your-voice).
