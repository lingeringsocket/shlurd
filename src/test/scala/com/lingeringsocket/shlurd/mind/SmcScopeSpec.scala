...
class SmcScopeSpec extends Specification
{
  ...
  private val ordinalFirst =
    sentencePrinter.bundle.ordinalNumber(1, GENDER_NEUTER)

  private val ordinalSecond =
    sentencePrinter.bundle.ordinalNumber(2, GENDER_NEUTER)
